/**
 * @file tokeniser-context.cpp
 * @author Hongxing Hao (a1845302@adelaide.edu.au)
 * @brief privided support for tokeniser to remember the input characters
 * @version 0.1
 * @date 2022-05-05
 * 
...
namespace Assignment_Tokeniser
{
    ...
    // remember each byte required.
    static vector<string> store(0);
